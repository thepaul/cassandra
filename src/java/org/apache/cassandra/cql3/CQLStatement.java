...
public interface CQLStatement
{
     ...
     */
    public ResultMessage execute(ClientState state, List<ByteBuffer> variables) throws RequestValidationException, RequestExecutionException, SchemaDisagreementException;
}
