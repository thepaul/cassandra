...
public class QueryProcessor
{
    ...
    throws  RequestExecutionException, RequestValidationException, SchemaDisagreementException
    {
    ...
    throws RequestValidationException, RequestExecutionException, SchemaDisagreementException
    {
